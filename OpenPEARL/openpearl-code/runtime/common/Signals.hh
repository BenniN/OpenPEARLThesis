/* classImpl : auto generated (Sun Aug 23 13:28:57 2020) */
...
class FunctionParameterOutOfRangeException : public ArithmeticSignal {
 public:
...
class CharacterNotValidSignal : public Signal {
 public:
 CharacterNotValidSignal() {
   type = (char*)"illegal value in TOCHAR";
   rstNum = 304;
 };
};

class CharIsINVSignal : public Signal {
 public:
 CharIsINVSignal() {
...
class BadArraySliceSignal : public Signal {
 public:
 BadArraySliceSignal() {
...
/* extList : auto generated (Sun Aug 23 13:28:57 2020) */
...
extern CharacterNotValidSignal theCharacterNotValidSignal;
...
extern BadArraySliceSignal theBadArraySliceSignal;
